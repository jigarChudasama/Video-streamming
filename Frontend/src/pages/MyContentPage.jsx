...
import UploadVideo from '../components/model/UploadVideo';
...
function MyContentPage() {
    ...
    const [createVideoModel, setCreateVideoModel] = useState(false)
    ...
    return (
        <div>
            <section className="w-full pb-[70px] sm:ml-[70px] sm:pb-0 lg:ml-0">
                <button onClick={() => {
                    setCreateVideoModel(true)
                }}
                    className="mt-4 ml-4 inline-flex items-center gap-x-2 bg-[#ae7aff] px-3 py-2 font-semibold text-black  ">
                    <svg
                ...
                {myContentVideos.length > 0 ? (
                    <div className="flex flex-col gap-4 p-4">
                        {myContentVideos.map((myContentVideo) => (
                            <div
                                key={myContentVideo.id}
                                onClick={() => {
                ...
                <UploadVideo createVideoModel={createVideoModel} setCreateVideoModel={setCreateVideoModel} />
            </section>
